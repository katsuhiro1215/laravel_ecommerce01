          ...
          <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                  ...
                  <ul class="dropdown-menu animated flipInX">
                      <li class="user-body">
                          <a class="dropdown-item" href="{{ route('admin.profile.edit') }}"><i class="ti-user text-muted mr-2"></i>
                              プロフィール</a>
                          <a class="dropdown-item" href="{{ route('admin.password.edit') }}"><i class="ti-wallet text-muted mr-2"></i> パスワード変更</a>
