      ...
      <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview {{ ($route == 'brand') ? 'active' : '' }}">
              ...
              <ul class="treeview-menu">
                  <li class="{{ ($route == 'brand.create') ? 'active' : '' }}"><a href="{{ route('brand.create') }}"><i class="ti-more"></i>一覧</a></li>
              </ul>
          </li>
          ...
          <li class="treeview {{ ($route == 'category') ? 'active' : '' }}">
              ...
              <ul class="treeview-menu">
                  <li class="{{ ($route == 'category.create') ? 'active' : '' }}"><a href="{{ route('category.create') }}"><i class="ti-more"></i>カテゴリー一覧</a></li>
                  <li class="{{ ($route == 'subCategory.create') ? 'active' : '' }}"><a href="{{ route('subCategory.create') }}"><i class="ti-more"></i>サブカテゴリー一覧</a></li>
                  <li class="{{ ($route == 'subSubCategory.create') ? 'active' : '' }}"><a href="{{ route('subSubCategory.create') }}"><i class="ti-more"></i>サブサブカテゴリー一覧</a></li>
              </ul>
          </li>
