    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                @include('frontend.sidebar.side-menu')

                @include('frontend.sidebar.hot-deals')

                @include('frontend.sidebar.special-offer')

                @include('frontend.sidebar.product-tags')

                @include('frontend.sidebar.special-deals')

                @include('frontend.sidebar.newsletter')

                @include('frontend.sidebar.testimonials')
                ...
                <div id="hero">
                    <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
                        @foreach ($heros as $hero)
                            <div class="item" style="background-image: url({{ asset($hero->hero_photo_path) }});">
                                <div class="container-fluid">
                                    <div class="caption bg-color vertical-center text-left">
                                        <div class="big-text fadeInDown-1">{{ $hero->title }} </div>
                        ...
                        <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                            ...
                            @foreach ($categories as $category)
                                <li><a data-transition-type="backSlide" href="#category{{ $category->id }}"
                                        data-toggle="tab">{{ $category->name_ja }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                                                    ...
                                                    <div class="product-image">
                                                        <div class="image"> <a
                                                                href="{{ url('product/details/' . $product->id . '/' . $product->slug) }}"><img
                                                                    src="{{ asset($product->thumbnail) }}"></a> </div>
                                                        @php
                            ...
                            <div class="tab-pane" id="smartphone">
                                <div class="product-slider">
                                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                                        ...
                                        @php
                                            $categoryWiseProduct = App\Models\Product::where('category_id', $category->id)
                                                ->orderBy('id', 'DESC')
                                                ->get();
                                        @endphp
